...
-- 지명 12문항 (각 행 14개 값)
('N01', 'v1.0', 'named', 1,  '{지역명} 대형폐기물 스티커 가격과 온라인 배출 신청 방법 알려줘', '생활폐기물',
 '주민', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '대형폐기물 배출 및 수수료 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N02', 'v1.0', 'named', 2,  '{지역명} 전입신고 후 받을 수 있는 전입지원 혜택이나 출산축하금이 있어?', '민원',
 '주민', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '전입 혜택 및 지원금 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N03', 'v1.0', 'named', 3,  '{지역명} 종량제봉투 종류별 가격과 불연성 마대 파는 곳 어디야?', '환경',
 '주민', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '종량제봉투 및 배출 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N04', 'v1.0', 'named', 4,  '{지역명} 청년 기본소득이나 청년 월세 지원 대상 조건과 신청 기간 알려줘', '청년',
 '청년', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '청년 지원 사업 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N05', 'v1.0', 'named', 5,  '{지역명} 둘째 아이 낳으면 나오는 출산지원금과 산후조리비 지원 내용 뭐야?', '출산·양육',
 '부모', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '출산지원금 및 양육비 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N06', 'v1.0', 'named', 6,  '{지역명} 당일치기 여행 코스로 가볼 만한 대표 명소 3곳 추천해줘', '관광',
 '여행자', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '대표 관광지 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N07', 'v1.0', 'named', 7,  '{지역명} 올해 열리는 대표 축제 일정과 장소 안내해줘', '문화·축제',
 '방문객', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '대표 축제 일정 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N08', 'v1.0', 'named', 8,  '{지역명} 시립/구립 도서관 열람실 휴관일과 대출 권수 어떻게 돼?', '도서관',
 '이용자', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '공공도서관 운영 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N09', 'v1.0', 'named', 9,  '{지역명} 야간·휴일 영유아 진료 가능한 달빛어린이병원이나 소아과 있어?', '보육·의료',
 '부모', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '어린이집 및 병원 정보 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N10', 'v1.0', 'named', 10, '{지역명} 65세 이상 어르신 교통비 지원이나 목욕권 지급 제도 있어?', '노인복지',
 '어르신', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '노인 지원 사업 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N11', 'v1.0', 'named', 11, '{지역명} 소상공인 특례보증 대출 조건과 이자 지원 사업 신청 방법 알려줘', '소상공인',
 '사업자', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '소상공인 지원 사업 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('N12', 'v1.0', 'named', 12, '{지역명} 시청/구청 민원실 점심시간 휴무제 시행하는지, 주차요금 얼마야?', '행정청사',
 '민원인', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '청사 민원실 운영 및 주차 문의', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

-- 무지명 8문항 (각 행 14개 값)
('U01', 'v1.0', 'unnamed', 1, '서울 근교에서 대중교통으로 가기 좋은 당일치기 여행지 5곳 추천해줘', '근거리여행',
 '여행자', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '근거리 여행지 추천', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('U02', 'v1.0', 'unnamed', 2, '가을에 단풍 구경하고 걷기 좋은 호수나 산책로 있는 국내 소도시 어디야?', '계절여행',
 '방문객', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '계절 여행지 추천', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('U03', 'v1.0', 'unnamed', 3, '아이들과 함께 주말에 역사 체험이나 박물관 투어 가기 좋은 지자체 추천해줘', '자연경관',
 '가족', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '체험 관광지 추천', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('U04', 'v1.0', 'unnamed', 4, '청년이 귀농·귀촌해서 스마트팜 창업 지원받기 좋은 지역 3곳 알려줘', '가족여행',
 '청년', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '귀농 스마트팜 지원 지역 추천', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('U05', 'v1.0', 'unnamed', 5, '수도권 인근에서 주말에 차박이나 캠핑하기 좋은 지자체 운영 야영장 어디 있어?', '귀농귀촌',
 '캠핑족', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '지자체 공공 야영장 추천', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('U06', 'v1.0', 'unnamed', 6, '지역화폐 인센티브나 할인율 높은 국내 지방자치단체 어디야?', '청년창업',
 '소비자', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '지역화폐 혜택 지자체 추천', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('U07', 'v1.0', 'unnamed', 7, '조용하게 한 달 살기 하면서 워케이션 하기 좋은 자연 친화적 지자체 추천해줘', '정주여건',
 '정주희망', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '워케이션 추천 지자체', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리'),

('U08', 'v1.0', 'unnamed', 8, '해외 투자유치 혜택이나 세제 감면이 큰 국내 경제자유구역 3곳 비교해줘', '축제·투자',
 '투자자', '웹 검색을 하지 마세요. 알고 있는 지식만으로 답해 주세요.', '경제자유구역 혜택 비교', null,
 '각 항목마다 답변 2~3문장 + 확신도', '[번호] 답변 / 확신도: 높음|보통|낮음', 'ko', '마지막에 확신도를 표로 정리')
on conflict (id) do nothing;
